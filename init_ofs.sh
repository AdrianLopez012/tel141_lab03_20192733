...
BRIDGE_NAME=${1:-br-ofs}  # Parámetro: nombreOvS
shift  # Remover el primer parámetro

# Si no se especifican puertos, usar valores por defecto (excluyendo ens3)
if [ $# -eq 0 ]; then
    set -- ens4 ens5 ens6
fi
...
# Procesar cada interfaz especificada
for IFACE in "$@"; do
